...
# --- PRESS tokens: GENERATED by the `press` skill ---------------------------
# Do not edit the block below; `press check` fails CI if it drifts. To change a
# value for every product at once, edit press/brand/tokens.json and re-emit.
# FACES names the vendorable faces under assets/fonts/ — SF is not licensable,
# so Inter stands in for the display voice the site gets from -apple-system.
# >>> press:tokens v0.10.0 sha256:c7e1a7f43d4d GENERATED by @natjswenson/press, do not edit
PAPER = "#F5F0E6"
INK = "#181510"
DIM = "#6E675C"
ACCENT = "#E8501F"
